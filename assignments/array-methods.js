...
// Problem 1: Create a list of everyones email to let them know about future events
let emailList = runners.map(function(element){
    return element.email
})
console.log(emailList)


// Problem 2 list of participants from specific company
let skinix = runners.filter(function (element) {
    return element.company_name === "Skinix"
})
console.log(skinix);

// Problem 3 list of all companies
let listCompanies = runners.map( function(element){
